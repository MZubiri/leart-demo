...
export class CatalogPage {
  readonly categories=['Todos','Sets armables','Minibox','Minifiguras'] as const;
  readonly occasions=['Todas','Pareja','Cumpleaños','Profesiones','Graduación','Deportes'] as const;
